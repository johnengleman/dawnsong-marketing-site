import type { PrivacyPolicyContent } from "./privacyContent";
...
export function PrivacyPolicyPage({
  ...
  return (
    <main
      className="min-h-screen bg-[#fffbf7] text-[#2d2a26]"
    ...
    >
      <div className="mx-auto w-full max-w-3xl px-6 py-20">
        ...
        <p className="mb-10 text-sm text-[#6b6560]">{content.lastUpdated}</p>
